...
const socket = new WebSocket('wss://5ifn4aitu6.execute-api.eu-central-1.amazonaws.com/Dev?id=USR-89308c3a-30c4-4400-8313-eb9b0d31b056');
...
const handleJoin = async () => {
    ...
    socket.send(
        JSON.stringify({
            ...
            event: 'join',
            sender: 'USR-89308c3a-30c4-4400-8313-eb9b0d31b056',
            token: 'eyJhbGciOiJIUzUxMiJ9..Iw3NcKZB2ICtBDqmH1ugt_f0kWzApPBzmRw0wrHdQVQS5OiTLyLcMS7xIUJY0awNeSaFitcrAUEV7isXUC0mgQ',
